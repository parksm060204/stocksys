...
export const MacroRegimeRebalanceWidget: React.FC<MacroRegimeWidgetProps> = ({ onRegimeChange }) => {
  ...
  return (
    <div className="bg-[#0E1117] border border-border p-5 text-xs font-mono rounded-3xl select-none shadow-2xl space-y-4">
        ...
        <div className="flex items-center gap-2">
          <span className={`px-3 py-1 rounded-full text-xs font-black border ${
            currentProfile.isSpecialParadigm
              ? 'bg-up/20 text-up border-[#F04452]/40 animate-pulse'
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-extrabold whitespace-nowrap transition-all cursor-pointer ${
                activeRegime === tab.key
                  ...
                  : 'bg-[#05070A] text-[#8E939D] border border-border hover:text-white'
              }`}
            >
              {tab.label}
            </button>
          ...
          <button
            ...
            className={`p-2.5 rounded-xl border text-left transition-all cursor-pointer ${
              activeRegime === 'BIO_REVOLUTION'
                ...
                : 'bg-[#161B22] border-border text-[#C1C7D0] hover:border-[#A855F7]/50'
            }`}
          >
          ...
          <button
            ...
            className={`p-2.5 rounded-xl border text-left transition-all cursor-pointer ${
              activeRegime === 'CLIMATE_CLEAN_ENERGY'
                ? 'bg-up/20 border-[#F04452] text-white shadow-[0_0_15px_rgba(240,68,82,0.3)]'
                : 'bg-[#161B22] border-border text-[#C1C7D0] hover:border-[#F04452]/50'
            }`}
          >
            <span className="font-extrabold text-[11.5px] block text-up">🌱 친환경 대전환</span>
          ...
          <button
            ...
            className={`p-2.5 rounded-xl border text-left transition-all cursor-pointer ${
              activeRegime === 'QUANTUM_AI_SINGULARITY'
                ...
                : 'bg-[#161B22] border-border text-[#C1C7D0] hover:border-[#00C805]/50'
            }`}
          >
          ...
          <button
            ...
            className={`p-2.5 rounded-xl border text-left transition-all cursor-pointer ${
              activeRegime === 'DEFENSE_SPACE_COLONIZATION'
                ...
                : 'bg-[#161B22] border-border text-[#C1C7D0] hover:border-[#EC4899]/50'
            }`}
          >
      ...
      <div className="bg-[#05070A] p-3 rounded-xl border border-border space-y-2">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-[#161B22] border border-border rounded-xl px-3 py-1.5 text-xs text-white outline-none focus:border-amber-400 font-sans"
          />
          <button
        ...
        {customNewsResult && (
          <div className="bg-[#161B22] p-2.5 rounded-xl border border-border text-xs text-amber-300 font-sans">
      ...
      <div className="bg-[#05070A] p-4 rounded-2xl border border-border space-y-2.5">
        ...
        <div className="flex justify-between items-center text-xs bg-[#161B22] p-2.5 rounded-xl border border-border">
