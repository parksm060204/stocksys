...
export interface SettlementTrade {
  /** Generated by the owning order transaction before settlement starts. */
  id?: string;
  stock_id: string;
...
): Promise<{ success: boolean; settled_count: number; trade_ids: string[]; error?: any }> {
  if (!trades || trades.length === 0) {
    return { success: true, settled_count: 0, trade_ids: [] };
  }
