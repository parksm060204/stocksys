...
exports.WallBreakerAgent = void 0;
const BaseAgent_1 = require("./BaseAgent");
class WallBreakerAgent extends BaseAgent_1.BaseAgent {
    huntCooldowns = {};
    constructor() {
        super({ id: 'WALL_BREAKER', baseWeights: { stock: 0, bond: 0, commodity: 0, cash: 1 } }, 100000000000); // 1000억 실탄 대기
    }
    // 이벤트 주도형 호출
    executeGammaSqueezeHunt(tickInfo, currentPrices, optionsData) {
        const orders = [];
        // Cooldown decay
        ...
        for (const stockId in currentPrices) {
            ...
            if (!optionChain || !optionChain.calls)
                continue;
...
exports.WallBreakerAgent = WallBreakerAgent;
//# sourceMappingURL=WallBreakerAgent.js.map