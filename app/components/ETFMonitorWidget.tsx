...
export const ETFMonitorWidget: React.FC<ETFMonitorProps> = ({ navData, lpQuote }) => {
  ...
  return (
    <div className="bg-[#0E1117] border border-border p-4 text-xs font-mono rounded-2xl select-none shadow-xl">
      {/* 타이틀, 괴리율 뱃지 및 상세 가이드 버튼 */}
      <div className="flex justify-between items-center mb-3 pb-2 border-b border-border">
        <div className="flex items-center space-x-2">
          <span className="text-up font-black text-[13px]">{navData.etfTicker}</span>
          <span className="text-[#8E939D] text-xs font-bold">ETF iNAV Monitor</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className={`px-2.5 py-0.5 rounded-full text-[10.5px] font-extrabold border tabular-nums ${
            isPremium ? 'bg-up/15 text-up border-[#F04452]/30' : 'bg-down/15 text-down border-[#3182F6]/30'
          }`}>
      ...
      <div className="grid grid-cols-2 gap-2 mb-3 bg-[#05070A] p-3 rounded-xl border border-border">
        <div>
      ...
      {/* LP 앵커링 시세 안정화 상태 표시 */}
      <div className="bg-[#161B22] p-2.5 rounded-xl border border-border mb-3 flex items-center justify-between">
      ...
      <div className="border-t border-border pt-2.5">
        ...
        <div className="flex justify-between items-center text-[11.5px] bg-[#161B22] px-3 py-1.5 rounded-lg border border-border">
      ...
      {showGuideModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 font-sans select-none">
          <div className="w-full max-w-lg rounded-3xl border border-border bg-[#0E1117] p-6 shadow-2xl space-y-4 text-xs">
            ...
            <div className="space-y-3 text-[#C1C7D0] leading-relaxed">
              <div className="bg-[#05070A] p-3.5 rounded-2xl border border-border space-y-1.5">
              ...
              <div className="bg-[#05070A] p-3.5 rounded-2xl border border-border space-y-1">
