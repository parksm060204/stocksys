    ...
    <div className="space-y-6">
      ...
      <div className="rounded-3xl bg-gradient-to-r from-[#151821] via-[#1C1C1E] to-[#151821] p-8 border border-white/5 relative overflow-hidden shadow-lg">
        <div className="relative z-10 max-w-2xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-down/10 border border-[#3182F6]/20 px-3 py-1 text-[12px] font-mono text-down font-bold mb-4">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              href="/v2/stocks"
              className="rounded-xl bg-down px-5 py-2.5 text-[13.5px] font-bold text-white hover:bg-down/90 transition-all shadow-md"
            >
              V2 주식 시장 탐색하기 ➔
            </Link>
            <Link
              href="/v2/institutions"
              className="rounded-xl bg-panel2 px-5 py-2.5 text-[13.5px] font-bold text-white hover:bg-white/10 transition-all border border-white/5"
            >
              기관 포트폴리오 관제 🏛️
            </Link>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        >
          ...
          <Link
            href="/v2/stocks"
            className="text-[12px] font-bold text-down hover:underline inline-flex items-center gap-1"
          >
            V2 주식 시장으로 이동 ➔
          </Link>
        </V2Card>
