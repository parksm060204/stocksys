...
exports.OptionsMMAgent = void 0;
const BaseAgent_1 = require("./BaseAgent");
class OptionsMMAgent extends BaseAgent_1.BaseAgent {
    bot;
     ...
     */
    getGamma(currentPrice, strike, stdDev) {
        // 가우시안 기반 감마 근사
    ...
    executeDeltaHedging(currentMarket, orderBook) {
        const orders = [];
        const availableStocks = currentMarket.stocks || [];
        const optionsContracts = currentMarket.options_contracts || [];
        for (const stock of availableStocks) {
            const stockId = stock.id;
            const stockOptions = optionsContracts.filter((o) => o.underlying_stock_id === stockId);
            // 관련 옵션이 없으면 패스
...
exports.OptionsMMAgent = OptionsMMAgent;
//# sourceMappingURL=OptionsMMAgent.js.map