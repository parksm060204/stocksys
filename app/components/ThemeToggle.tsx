    ...
    <div className={`relative inline-block select-none ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className={`group flex h-7 w-7 items-center justify-center rounded-lg border transition-all duration-150 cursor-pointer ${
          isOpen
            ? "border-up bg-panel shadow-[0_0_8px_rgba(240,68,82,0.3)] ring-1 ring-[#F04452]"
            : "border-border bg-panel2 hover:bg-hover shadow-sm"
        }`}
      ...
      {isOpen && (
        <div className="absolute right-0 mt-1.5 w-36 rounded-xl border border-border bg-panel/95 backdrop-blur-md p-1 shadow-2xl z-50 animate-in fade-in duration-100 flex flex-col gap-0.5 font-sans">
          {/* 옵션 1: 시스템 */}
          <button
            type="button"
            onClick={() => {
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg text-[12px] font-medium transition-colors cursor-pointer ${
              theme === "light"
                ...
                : "text-muted hover:bg-hover hover:text-amber-500"
            }`}
          >
            <div className="flex items-center gap-2">
            ...
            {theme === "light" && <span className="text-amber-500 text-xs font-bold">✓</span>}
          </button>
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg text-[12px] font-medium transition-colors cursor-pointer ${
              theme === "dark"
                ...
                : "text-muted hover:bg-hover hover:text-indigo-400"
            }`}
          >
            <div className="flex items-center gap-2">
