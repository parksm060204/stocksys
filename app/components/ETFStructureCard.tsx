  ...
  return (
    <div className="bg-[#0E1117] border border-border p-5 text-xs font-mono rounded-3xl select-none shadow-2xl space-y-4">
      ...
      <div className="flex justify-between items-center border-b border-border pb-3">
        ...
        <span className="text-xs font-bold text-up bg-up/10 px-2.5 py-1 rounded-full border border-[#F04452]/30">
      ...
      <div className="grid grid-cols-3 gap-2 bg-[#05070A] p-3 rounded-2xl border border-border">
        <div>
      ...
      <div className="space-y-2">
        ...
        <div className="overflow-x-auto rounded-xl border border-border bg-[#05070A]">
          <table className="w-full text-left border-collapse font-mono text-[11.5px]">
            <thead>
              <tr className="border-b border-border bg-[#161B22] text-[#8E939D] text-[10.5px]">
