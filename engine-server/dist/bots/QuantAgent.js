...
exports.QuantAgent = void 0;
const BaseAgent_1 = require("./BaseAgent");
const EventBus_1 = require("../EventBus");
class QuantAgent extends BaseAgent_1.BaseAgent {
    bot;
    pendingNews = [];
    constructor(bot) {
        ...
        EventBus_1.EventBus.subscribe('NEWS_ALERT', (event) => {
    ...
    executeQuantStrategy(currentMarket, orderBook) {
        const orders = [];
        ...
        for (const item of newsToProcess) {
            ...
            const stock = availableStocks.find((s) => s.id === targetStockId || s.sector === targetStockId);
            if (!stock)
                continue;
...
exports.QuantAgent = QuantAgent;
//# sourceMappingURL=QuantAgent.js.map